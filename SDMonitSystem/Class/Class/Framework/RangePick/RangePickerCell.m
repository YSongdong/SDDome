...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        selectionLayer.backgroundColor = [UIColor tabBarItemTextColor].CGColor;
        ...
        middleLayer.backgroundColor = [[UIColor tabBarItemTextColor] colorWithAlphaComponent:0.3].CGColor;
